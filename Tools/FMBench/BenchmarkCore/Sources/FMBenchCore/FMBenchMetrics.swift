...
public enum FMBenchTokenCountSource: String, Codable, Sendable {
    case sessionUsage
    case systemTokenizer
    case characterEstimate
}

public struct FMBenchTrialMetrics: Codable, Sendable {
    ...
    public let tokenCountSource: FMBenchTokenCountSource
    ...
    public init(
        ...
        tokenCountSource: FMBenchTokenCountSource,
        responseCharacterCount: Int,
        streamUpdateDates: [Date],
        reasoningTokenCount: Int? = nil,
        contextSize: Int? = nil,
        resourceSnapshots: [FMBenchResourceSnapshot] = []
    ) {
...
public struct FMBenchDistribution: Codable, Sendable {
