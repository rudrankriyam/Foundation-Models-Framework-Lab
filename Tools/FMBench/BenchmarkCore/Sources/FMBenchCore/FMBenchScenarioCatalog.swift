...
public enum FMBenchScenarioCatalog {
    ...
    public static let safety: [FMBenchScenario] = [
    ...
    public static let workoutPlan = FMBenchScenario(
        id: "workout-plan",
    ...
    public static let journalSummary = FMBenchScenario(
        id: "journal-summary",
    ...
    public static let habitClassification = FMBenchScenario(
    ...
    public static let groundedExplanation = FMBenchScenario(
    ...
    public static let exerciseSubstitution = FMBenchScenario(
    ...
    public static let documentQuestionAnswering = FMBenchScenario(
    ...
    public static let citationExtraction = FMBenchScenario(
    ...
    public static let creativeWriting = FMBenchScenario(
        id: "creative-writing",
    ...
    public static let visualRecommendation = FMBenchScenario(
    ...
    public static let contextLimit = FMBenchScenario(
        id: "context-limit",
...
private typealias SampleBase = (prompt: String, checks: [FMBenchCheck])
...
private func expandedSamples(id: String, bases: [SampleBase]) -> [FMBenchSample] {
...
private let visualSamples: [FMBenchSample] = promptVariants.enumerated().flatMap {
