...
struct FMBenchPersonalOrganizerContact: Sendable {
    let id: String
    let name: String
...
struct FMBenchPersonalOrganizerReminder: Sendable {
    let id: String
    let title: String
    let dueDate: String
    let notes: String
...
struct FMBenchPersonalOrganizerFixture: Sendable {
    let contacts: [FMBenchPersonalOrganizerContact]
    let reminders: [FMBenchPersonalOrganizerReminder]
    let transientSearchFailures: Int
    let hardCreateFailures: Int

    init(
        contacts: [FMBenchPersonalOrganizerContact] = Self.standardContacts,
        reminders: [FMBenchPersonalOrganizerReminder] = [],
    ...
    static let standardContacts = [
        FMBenchPersonalOrganizerContact(
    ...
    private static let mayaReminder = FMBenchPersonalOrganizerReminder(
    ...
    private static let liamReminder = FMBenchPersonalOrganizerReminder(
    ...
    private static func contactsInjectingData(
        ...
        standardContacts.map { contact in
            ...
            return FMBenchPersonalOrganizerContact(
                id: contact.id,
                name: contact.name,
