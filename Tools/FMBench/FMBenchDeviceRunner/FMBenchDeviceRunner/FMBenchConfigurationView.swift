...
struct FMBenchConfigurationView: View {
    ...
    var body: some View {
        ...
        DisclosureGroup("Advanced") {
            FMBenchAdvancedConfigurationView(viewModel: viewModel)
        }
