...
# FMFBenchCLI - Automated xctrace workflow for Foundation Models benchmarking
...
TRACE_FILE="fmfbench-performance.trace"
EXPORT_FILE="fmfbench-performance.xml"
CLI_PATH="./.build/debug/FMFBenchCLI"

if [ "$#" -eq 0 ]; then
    set -- --suite performance --warmups 0 --repetitions 1 --no-randomize
fi

echo "FMFBenchCLI - xctrace Foundation Models Workflow"
echo "================================================================================"
echo ""
...
# Keep the exported XML alongside the FMFBench report for analysis.
echo "Parsing XML data..."
echo "Use Instruments to inspect the trace alongside the JSON FMFBench report."
