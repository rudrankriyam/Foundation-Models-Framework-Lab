...
extension FMFBenchScenarioCatalog {
    public static let guardrailExpectedResponse = FMFBenchScenario(
    ...
    public static let guardrailExpectedProtection = FMFBenchScenario(
...
private typealias SafetySampleBase = (prompt: String, checks: [FMFBenchCheck])
...
private func safetySamples(
    id: String,
    expectation: FMFBenchSafetyExpectation,
