...
public struct EnvironmentSnapshot: Codable, Sendable {
    ...
    public let fmfBenchCommit: String?
    ...
    public init(
        ...
        self.fmfBenchCommit = fmfBenchCommit
    ...
    public static func capture() -> EnvironmentSnapshot {
        ...
        return EnvironmentSnapshot(
            deviceName: processInfo.environment["FMFBENCH_DEVICE_NAME"] ?? hardwareModel ?? systemName,
            ...
            fmfBenchCommit: processInfo.environment["FMFBENCH_COMMIT"]
        )
    }
